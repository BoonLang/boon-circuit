...
use boon_plan::{
    ...
    RemoteCallSiteId, RemoteCallSitePlan, SourceId, SourceRouteToken,
};
use boon_runtime::{
    DistributedCurrentCallInstance, DocumentFrame, DocumentPatch, LiveRuntime,
    LiveRuntimeBuildPoll, LiveRuntimeBuildTask, MachineBuildProgress, MachineTemplate, RowId,
    RuntimeTurn, SessionConnectionStatus, SessionOptions, SessionPrincipal, SourceEvent,
    SourcePayload, TransientEffectCallId, Value,
};
...
impl EndpointRuntime {
    ...
    pub(super) fn demand_document_window_by_id(
        ...
        visible: Range<u64>,
        overscan: Range<u64>,
    ) -> Result<Vec<DocumentPatch>, DistributedRuntimeError> {
        self.machine
            .runtime
