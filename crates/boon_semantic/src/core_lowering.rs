...
pub(crate) struct CanonicalProgramCoreBuildV2 {
    ...
    pub(crate) execution_handoff: crate::semantic_image::ExecutionImageHandoffV5,
...
pub(super) fn map_semantic_execution_with_reactive(
    ...
    receipts: &mut crate::semantic_image::ExecutionReceiptPublisherV5<'_>,
...
pub(crate) fn build_canonical_program_core(
    ...
    mut receipts: crate::semantic_image::ExecutionReceiptPublisherV5<'_>,
